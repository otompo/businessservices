  ...
  return (
    ...
    >
      ...
      >
        ...
        <SubMenu key="10" icon={<HomeOutlined />} title="Home">
          ...
          <Menu.Item key="5" icon={<VerticalAlignMiddleOutlined />}>
            <Link href="/admin/bookings" legacyBehavior>
              <a className={activeName("/admin/bookings")}>Manage Bookings</a>
            </Link>
          </Menu.Item>
          <Menu.Item key="7" icon={<VerticalAlignMiddleOutlined />}>
            <Link href="/admin/ourservices" legacyBehavior>
              <a className={activeName("/admin/ourservices")}>
                Manage Services
              </a>
            </Link>
          </Menu.Item>
        ...
        {/* Customize */}
        <Menu.Item key="8" icon={<BgColorsOutlined />}>
          <Link href="/admin/customize" legacyBehavior>
            <a className={activeName("/admin/customize")}>Customize</a>
          </Link>
        </Menu.Item>

        <Menu.Item key="13" icon={<BiUser />}>
          <Link href={`/profile/${user?.user?._id}`} legacyBehavior>
            <a className={activeName(`/${user?.user?._id}`)}>Profile</a>
          </Link>
        </Menu.Item>
